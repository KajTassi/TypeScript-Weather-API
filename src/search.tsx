...
const Search = ({
    ...
    from-amber-400 via-rose-400 to-emerald-400 h-[100vh] w-full">
      ...
      <p className="text-sm mt-2">
        Want to know the weather in your current city or somewhere else? Then don't hesitate to use the search
        bar below to see a dropdown of options, and find the weather!   
      </p> 
        ...
        <div className="relative flex mt-10 md:mt-4">
          ...
          {options.map((option: optionType, index: number) => (
            <li key={option.name + '-' + index}>
              <button className="text-left text-sm w-full hover:bg-zinc-700 hover:text-white
              px-2 py-1 cursor-pointer" onClick={() => onOptionSelect(option)}>
